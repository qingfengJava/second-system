package com.qingfeng.currency.authority.biz.service.mq.producer;
...
public class RabbitSendMsg implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnCallback{
    ...
    public void sendEmail(String message,String routingKey) {
        ...
        rabbitTemplate.convertAndSend(RabbitMqConfig.AUTH_EXCHANGE_DECLARE_INFORM,routingKey,this.setMessage(message));
    }
    ...
    public void returnedMessage(Message message, int replyCode, String replyText, String exchange, String routingKey) {
        ...
        try {
            Thread.sleep(10000L);
            //  重新发送消息至队列,此处应写一套重发机制,重发多少次结束,否则如果消息如果一直发送失败,则会一直发下去!
