...
@Configuration
@Slf4j
public class ItemServerMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public ItemServerMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
