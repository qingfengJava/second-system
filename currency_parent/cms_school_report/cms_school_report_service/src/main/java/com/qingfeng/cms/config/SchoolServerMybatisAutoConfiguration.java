...
@Configuration
@Slf4j
public class SchoolServerMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public SchoolServerMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
