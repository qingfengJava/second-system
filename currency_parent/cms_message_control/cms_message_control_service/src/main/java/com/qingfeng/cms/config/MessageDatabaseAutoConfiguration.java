...
import com.qingfeng.currency.database.datasource.BaseDatabaseConfiguration;
...
@MapperScan(
        ...
        sqlSessionFactoryRef = MessageDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class, DatabaseProperties.class})
public class MessageDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public MessageDatabaseAutoConfiguration(MybatisPlusProperties properties,
