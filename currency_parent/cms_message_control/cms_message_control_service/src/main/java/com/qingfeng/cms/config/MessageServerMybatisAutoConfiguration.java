...
@Configuration
@Slf4j
public class MessageServerMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public MessageServerMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
