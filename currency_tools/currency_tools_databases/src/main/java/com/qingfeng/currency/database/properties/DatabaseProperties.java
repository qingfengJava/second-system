package com.qingfeng.currency.database.properties;
...
import static com.qingfeng.currency.database.properties.DatabaseProperties.PREFIX;
...
public class DatabaseProperties {
    public static final String PREFIX = "currency.database";
    /**
     * 攻击 SQL 阻断解析器
     */
